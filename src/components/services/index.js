                    ...
                    <Box maxHeight="100%" maxWidth="100%">
                        <Grid container spacing={2} justifyContent="center" alignItems="center"  >
                            {servicesData?.map((item) => (
                                <Grid item xs={6} md={4} key={item.id} data-aos="fade-down" data-aod-delay={`${item.id}`}>
                                    <Card sx={{
                                        maxWidth: "100%", minHeight: {xs:"40vh",md:"30vh"},maxHeight:{xs:"40vh",md:"30vh"}, borderRadius: 5, display: "flex"
                                        , flexDirection: "column", alignItems: "center", backgroundColor: "#F5F5F5", boxShadow: "inset 0 0 0 0 #80C9FA"
                                        ,
                                        "&:hover": {
                                            // background: "#d4e5f1",
